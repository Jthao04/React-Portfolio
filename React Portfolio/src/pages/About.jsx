        ...
        <div className="container text-left bg-primary-gradient">
            <div className="row align-items-start">
                ...
                <div className="col-12 col-md-8">
                    ...
                    <p className="text-light">After taking some time off school, I had decided to actually go into pharmacy to become a pharmacist. I then went back to a community college to finish up the rest of the required pre-requisite courses before applying to pharmacy school. Throughout that time, I worked as a pharmacy technician gaining a lot of experience and knowledge on what it was like to work in a pharmacy and by observing the pharmacist and what they do. Through perserverance and hard work, I had gotten into pharmacy school. Sadly after working in a pharmacy for abour 2-3 years, I realized pharmacy wasn't for me.</p>
